...
do
IN=$FINALVCF/$PREFIX.All.$TYPE.combined_selected.NO.TE.vcf.gz
STEP1=$FINALVCF/$PREFIX.All.$TYPE.no_missing_no_fixed.vcf.gz
STEP2=$FINALVCF/$PREFIX.All.$TYPE.no_missing_no_fixed.tsv
